...
这个目标不能靠堆链接完成。仓库必须持续提供四类价值：

1. 新手能照着走的学习路线。
2. 真实可复用的 skills、提示词和工作流。
3. 经审计、脱敏、有判断的学习笔记。
4. 从新鲜 AI 动态里提炼出的可执行方法，而不是新闻搬运。
...
目标：解决“最近 Agent 领域有什么真正值得学”的问题。

内容形态：

- AIHot 最近 7 天精选的 Agent / Skill / Prompt / MCP / Automation 相关条目拆解。
- 从官方博客、GitHub、论文或文档补充一手来源。
- 每期只保留能转成学习任务、提示词、skill 或安全边界的内容。
...
- 从 AIHot 选 3-5 个 Agent 新动态，拆成一篇方法导读。
